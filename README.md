...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/xtrude-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11074&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/xtrude-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `xtrude` can be installed with:

```
conda install xtrude
```

It is possible to list all of the versions of `xtrude` available on your platform with:
